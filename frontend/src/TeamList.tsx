...
function TeamList() {
  ...
  const [fakeTeams, setFakeTeams] = useState<Team[]>([{ id: 1, name: 'Team 1', level: Level.Junior, type: Type.Masculine, sport: Sport.Soccer }]);

  const [error, setError] = useState<string | null>(null);
  const [editTeam, setEditTeam] = useState<Team>({ id: -1, name: '', level: Level.None, type: Type.None, sport: Sport.None });
  const [newTeam, setNewTeam] = useState<Team>({ id: -1, name: '', level: Level.None, type: Type.None, sport: Sport.None });
  ...
  async function handleViewClick() {
    ...
    const handleNewTeamSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        setNewTeam({ id: -1, name: '', level: Level.None, type: Type.None, sport: Sport.None }); // Reset form fields
