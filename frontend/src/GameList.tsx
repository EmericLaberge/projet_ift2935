...
function GameList() {
  ...
  const [editGame, setEditGame] = useState<Game>({ id:-1, sport_name: '', event_id: -1, first_team_id: -1, second_team_id: -1, game_date: '', final_score: '' });
  const [rowModesModel, setRowModesModel] = React.useState<GridRowModesModel>({});
  const [newGame, setNewGame] = useState<Partial<Game>>({ sport_name: '', event_id: -1, first_team_id: -1, second_team_id: -1, game_date: '', final_score: '' });
  ...
  const handleNewGameSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewGame({ sport_name: '', event_id: -1, first_team_id: -1, second_team_id: -1, game_date: '', final_score: '' });
    ...
    <div className="App">
      ...
      <DataGrid
        ...
        columns={[
          ...
          { field: 'sport_name', headerName: 'Sport Name', width:100},
          { field: 'event_id', headerName: 'Event ID', width:100},
          { field: 'first_team_id', headerName: 'First Team ID', width:100},
          { field: 'second_team_id', headerName: 'Second Team ID', width:100},
          { field: 'game_date', headerName: 'Game Date', width:100},
          { field: 'final_score', headerName: 'Final Score', width:100},
          {
            field: 'actions',
            type: 'actions',
            headerName: 'Actions',
